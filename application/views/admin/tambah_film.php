...
<body>
   <div class="container">
     <h3 align="center"><b>MASUKAN FILM BARU</b></h3>
 <div class="col-md-3">
 </div>
 <div class="jumbotron col-md-6">
   <?=form_open_multipart('C_teater/proses_tambah')?>
    <div class="form-group">
      ...
      <input type="text" name="nama_film" class="form-control" placeholder="Masukan Nama Film" id="nama_film" required>
    </div>
    <div class="form-group">
      <label for="durasi">durasi :</label>
      <input type="text" name="durasi" class="form-control" placeholder="Masukan Durasi Film" id="durasi" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="sinopsis" class="form-control" placeholder="Masukan Sinopsis Film" id="sinopsis" required>
    </div>
    <div class="form-group">
