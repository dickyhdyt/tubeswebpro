...
<body style="background-color: lightgray">
	...
	<div align="center">                        
		<img src="<?= base_url(); ?>images/mtixlogo.jpg" class="lalala" style="width: 70%">                    
	</div>                    
	<div style="padding-top:30px" class="panel-body">                        
		<form action="<?= site_url('C_teater/Signin')?>" id="form_login" name="form_login" method="post" class="form-horizontal">                                                  
			<div style="margin-bottom: 25px" class="input-group">                                
				<span class="input-group-addon">
					<i class="glyphicon glyphicon-phone"></i></span>                                
				<input id="login" type="number" class="form-control" name="handphone" maxlength="20" placeholder="Handphone Number" required="">           
			</div>                            
			<div style="margin-bottom: 25px" class="input-group">                                
				<span class="input-group-addon">
